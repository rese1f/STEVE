...
class STEVE:
    def __init__(
        ...
        action_agent_model_name: str = "STEVE-13B",
        action_agent_temperature: float = 0,
        action_agent_task_max_retries: int = 4,
        action_agent_show_chat_log: bool = True,
        action_agent_show_execution_error: bool = True,
        curriculum_agent_model_name: str = "STEVE-13B",
        curriculum_agent_temperature: float = 0,
        curriculum_agent_qa_model_name: str = "STEVE-13B",
        curriculum_agent_qa_temperature: float = 0,
        curriculum_agent_warm_up: Dict[str, int] = None,
        curriculum_agent_core_inventory_items: str = r".*_log|.*_planks|stick|crafting_table|furnace"
        r"|cobblestone|dirt|coal|.*_pickaxe|.*_sword|.*_axe",
        curriculum_agent_mode: str = "auto",
        critic_agent_model_name: str = "STEVE-13B",
        critic_agent_temperature: float = 0,
        critic_agent_mode: str = "auto",
        skill_manager_model_name: str = "STEVE-13B",
        skill_manager_temperature: float = 0,
        skill_manager_retrieval_top_k: int = 5,
        openai_api_request_timeout: int = 240,
        ckpt_dir: str = "ckpt",
        skill_database_dir: str = None,
        resume: bool = False,
    ):
        # init env
        self.env = STEVEEnv(
        ...
        self.skill_manager = SkillManager(
            ...
            request_timout=openai_api_request_timeout,
            ckpt_dir=skill_database_dir if skill_database_dir else ckpt_dir,
            resume=True if resume or skill_database_dir else False,
        )
